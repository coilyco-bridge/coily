...
## `coily ops trello-api actions delete-actions-id`

Delete an Action

## `coily ops trello-api actions delete-actions-idaction-reactions-id`

Delete Action's Reaction

## `coily ops trello-api actions get-actions-id`

Get an Action

Flags: --display, --entities, --fields, --member, --memberCreator, --memberCreator_fields, --member_fields

## `coily ops trello-api actions get-actions-id-board`

Get the Board for an Action

Flags: --fields

## `coily ops trello-api actions get-actions-id-card`

Get the Card for an Action

Flags: --fields

## `coily ops trello-api actions get-actions-id-field`

Get a specific field on an Action

## `coily ops trello-api actions get-actions-id-list`

Get the List for an Action

Flags: --fields

## `coily ops trello-api actions get-actions-id-member`

Get the Member of an Action

Flags: --fields

## `coily ops trello-api actions get-actions-id-membercreator`

Get the Member Creator of an Action

Flags: --fields

## `coily ops trello-api actions get-actions-id-organization`

Get the Organization of an Action

Flags: --fields

## `coily ops trello-api actions get-actions-idaction-reactions`

Get Action's Reactions

Flags: --emoji, --member

## `coily ops trello-api actions get-actions-idaction-reactions-id`

Get Action's Reaction

Flags: --emoji, --member

## `coily ops trello-api actions get-actions-idaction-reactionsummary`

List Action's summary of Reactions

## `coily ops trello-api actions post-actions-idaction-reactions`

Create Reaction for Action

Flags: --body

## `coily ops trello-api actions put-actions-id`

Update an Action

Flags: --text

## `coily ops trello-api actions put-actions-id-text`

Update a Comment Action

Flags: --value

## `coily ops trello-api applications applications-key-compliance`

Get Application's compliance data

## `coily ops trello-api batch get-batch`

Batch Requests

Flags: --urls

## `coily ops trello-api boards boards-id-checklists`

Get Checklists on a Board

## `coily ops trello-api boards boardsidmembersidmember`

Remove Member from Board

## `coily ops trello-api boards delete-boards-id`

Delete a Board

## `coily ops trello-api boards get-board-id-plugins`

Get Power-Ups on a Board

Flags: --filter

## `coily ops trello-api boards get-boards-id`
...
## `coily ops trello-api boards get-boards-id-actions`
...
## `coily ops trello-api boards get-boards-id-boardplugins`

Get Enabled Power-Ups on Board

## `coily ops trello-api boards get-boards-id-boardstars`

Get boardStars on a Board

Flags: --filter

## `coily ops trello-api boards get-boards-id-cards`

Get Cards on a Board

## `coily ops trello-api boards get-boards-id-cards-filter`

Get filtered Cards on a Board

## `coily ops trello-api boards get-boards-id-customfields`

Get Custom Fields for Board

## `coily ops trello-api boards get-boards-id-field`

Get a field on a Board

## `coily ops trello-api boards get-boards-id-labels`

Get Labels on a Board

Flags: --fields, --limit

## `coily ops trello-api boards get-boards-id-lists`

Get Lists on a Board

Flags: --card_fields, --cards, --fields, --filter

## `coily ops trello-api boards get-boards-id-lists-filter`

Get filtered Lists on a Board

## `coily ops trello-api boards get-boards-id-members`

Get the Members of a Board

## `coily ops trello-api boards get-boards-id-memberships`

Get Memberships of a Board

Flags: --activity, --filter, --member, --member_fields, --orgMemberType

## `coily ops trello-api boards post-boards`
...
## `coily ops trello-api boards post-boards-id-calendarkey-generate`

Create a calendarKey for a Board

## `coily ops trello-api boards post-boards-id-emailkey-generate`

Create a emailKey for a Board

## `coily ops trello-api boards post-boards-id-idtags`

Create a Tag for a Board

Flags: --value

## `coily ops trello-api boards post-boards-id-labels`

Create a Label on a Board

Flags: --color, --name

## `coily ops trello-api boards post-boards-id-lists`

Create a List on a Board

Flags: --name, --pos

## `coily ops trello-api boards post-boards-id-markedasviewed`

Mark Board as viewed

## `coily ops trello-api boards put-boards-id`
...
## `coily ops trello-api boards put-boards-id-members`

Invite Member to Board via email

Flags: --body, --email, --type

## `coily ops trello-api boards put-boards-id-members-idmember`

Add a Member to a Board

Flags: --allowBillableGuest, --type

## `coily ops trello-api boards put-boards-id-memberships-idmembership`

Update Membership of Member on a Board

Flags: --member_fields, --type

## `coily ops trello-api boards put-boards-id-my-prefs-showsidebar`

Update showSidebar Pref on a Board

Flags: --value

## `coily ops trello-api boards put-boards-id-my-prefs-showsidebaractivity`

Update showSidebarActivity Pref on a Board

Flags: --value

## `coily ops trello-api boards put-boards-id-my-prefs-showsidebarboardactions`

Update showSidebarBoardActions Pref on a Board

Flags: --value

## `coily ops trello-api boards put-boards-id-my-prefs-showsidebarmembers`

Update showSidebarMembers Pref on a Board

Flags: --value

## `coily ops trello-api boards put-boards-id-myprefs-emailposition`

Update emailPosition Pref on a Board

Flags: --value

## `coily ops trello-api boards put-boards-id-myprefs-idemaillist`

Update idEmailList Pref on a Board

Flags: --value

## `coily ops trello-api cards cardsidmembersvoted-1`

Add Member vote to Card

Flags: --value

## `coily ops trello-api cards delete-cards-id`

Delete a Card

## `coily ops trello-api cards delete-cards-id-actions-id-comments`

Delete a comment on a Card

## `coily ops trello-api cards delete-cards-id-checkitem-idcheckitem`

Delete checkItem on a Card

## `coily ops trello-api cards delete-cards-id-checklists-idchecklist`

Delete a Checklist on a Card

## `coily ops trello-api cards delete-cards-id-idlabels-idlabel`

Remove a Label from a Card

## `coily ops trello-api cards delete-cards-id-membersvoted-idmember`

Remove a Member's Vote on a Card

## `coily ops trello-api cards delete-cards-id-stickers-idsticker`

Delete a Sticker on a Card

## `coily ops trello-api cards delete-id-idmembers-idmember`

Remove a Member from a Card

## `coily ops trello-api cards deleted-cards-id-attachments-idattachment`

Delete an Attachment on a Card

## `coily ops trello-api cards get-cards-id`
...
## `coily ops trello-api cards get-cards-id-actions`

Get Actions on a Card

Flags: --filter, --page

## `coily ops trello-api cards get-cards-id-attachments`

Get Attachments on a Card

Flags: --fields, --filter

## `coily ops trello-api cards get-cards-id-attachments-idattachment`

Get an Attachment on a Card

Flags: --fields

## `coily ops trello-api cards get-cards-id-board`

Get the Board the Card is on

Flags: --fields

## `coily ops trello-api cards get-cards-id-checkitem-idcheckitem`

Get checkItem on a Card

Flags: --fields

## `coily ops trello-api cards get-cards-id-checkitemstates`

Get checkItems on a Card

Flags: --fields

## `coily ops trello-api cards get-cards-id-checklists`

Get Checklists on a Card

Flags: --checkItem_fields, --checkItems, --fields, --filter

## `coily ops trello-api cards get-cards-id-customfielditems`

Get Custom Field Items for a Card

## `coily ops trello-api cards get-cards-id-field`

Get a field on a Card

## `coily ops trello-api cards get-cards-id-list`

Get the List of a Card

Flags: --fields

## `coily ops trello-api cards get-cards-id-members`

Get the Members of a Card

Flags: --fields

## `coily ops trello-api cards get-cards-id-membersvoted`

Get Members who have voted on a Card

Flags: --fields

## `coily ops trello-api cards get-cards-id-plugindata`

Get pluginData on a Card

## `coily ops trello-api cards get-cards-id-stickers`

Get Stickers on a Card

Flags: --fields

## `coily ops trello-api cards get-cards-id-stickers-idsticker`

Get a Sticker on a Card

Flags: --fields

## `coily ops trello-api cards post-cards`
...
## `coily ops trello-api cards post-cards-id-actions-comments`

Add a new comment to a Card

Flags: --text

## `coily ops trello-api cards post-cards-id-attachments`

Create Attachment On Card

Flags: --file, --mimeType, --name, --setCover, --url

## `coily ops trello-api cards post-cards-id-checklists`

Create Checklist on a Card

Flags: --idChecklistSource, --name, --pos

## `coily ops trello-api cards post-cards-id-idlabels`

Add a Label to a Card

Flags: --value

## `coily ops trello-api cards post-cards-id-idmembers`

Add a Member to a Card

Flags: --value

## `coily ops trello-api cards post-cards-id-labels`

Create a new Label on a Card

Flags: --color, --name

## `coily ops trello-api cards post-cards-id-markassociatednotificationsread`

Mark a Card's Notifications as read

## `coily ops trello-api cards post-cards-id-stickers`

Add a Sticker to a Card

Flags: --image, --left, --rotate, --top, --zIndex

## `coily ops trello-api cards put-cards-id`
...
## `coily ops trello-api cards put-cards-id-actions-idaction-comments`

Update Comment Action on a Card

Flags: --text

## `coily ops trello-api cards put-cards-id-checkitem-idcheckitem`

Update a checkItem on a Card

Flags: --due, --dueReminder, --idChecklist, --idMember, --name, --pos, --state

## `coily ops trello-api cards put-cards-id-stickers-idsticker`

Update a Sticker on a Card

Flags: --left, --rotate, --top, --zIndex

## `coily ops trello-api cards put-cards-idcard-checklist-idchecklist-checkitem-idcheckitem`

Update Checkitem on Checklist on Card

Flags: --pos

## `coily ops trello-api cards put-cards-idcard-customfield-idcustomfield-item`

Update Custom Field item on Card

Flags: --body

## `coily ops trello-api cards put-cards-idcard-customfields`

Update Multiple Custom Field items on Card

Flags: --body

## `coily ops trello-api checklists delete-checklists-id`

Delete a Checklist

## `coily ops trello-api checklists delete-checklists-id-checkitems-idcheckitem`

Delete Checkitem from Checklist

## `coily ops trello-api checklists get-checklists-id`

Get a Checklist

Flags: --cards, --checkItem_fields, --checkItems, --fields

## `coily ops trello-api checklists get-checklists-id-board`

Get the Board the Checklist is on

Flags: --fields

## `coily ops trello-api checklists get-checklists-id-cards`

Get the Card a Checklist is on

## `coily ops trello-api checklists get-checklists-id-checkitems`

Get Checkitems on a Checklist

Flags: --fields, --filter

## `coily ops trello-api checklists get-checklists-id-checkitems-idcheckitem`

Get a Checkitem on a Checklist

Flags: --fields

## `coily ops trello-api checklists get-checklists-id-field`

Get field on a Checklist

## `coily ops trello-api checklists post-checklists`

Create a Checklist

Flags: --idCard, --idChecklistSource, --name, --pos

## `coily ops trello-api checklists post-checklists-id-checkitems`

Create Checkitem on Checklist

Flags: --checked, --due, --dueReminder, --idMember, --name, --pos

## `coily ops trello-api checklists put-checklists-id-field`

Update field on a Checklist

Flags: --value

## `coily ops trello-api checklists put-checlists-id`

Update a Checklist

Flags: --name, --pos

## `coily ops trello-api custom-fields delete-customfields-id`

Delete a Custom Field definition

## `coily ops trello-api custom-fields delete-customfields-options-idcustomfieldoption`

Delete Option of Custom Field dropdown

## `coily ops trello-api custom-fields get-customfields-id`

Get a Custom Field

## `coily ops trello-api custom-fields get-customfields-id-options`

Add Option to Custom Field dropdown

## `coily ops trello-api custom-fields get-customfields-options-idcustomfieldoption`

Get Option of Custom Field dropdown

## `coily ops trello-api custom-fields post-customfields`

Create a new Custom Field on a Board

Flags: --body

## `coily ops trello-api custom-fields post-customfields-id-options`

Get Options of Custom Field drop down

## `coily ops trello-api custom-fields put-customfields-id`

Update a Custom Field definition

Flags: --body

## `coily ops trello-api emoji emoji`

List available Emoji

Flags: --locale, --spritesheets

## `coily ops trello-api enterprises delete-enterprises-id-organizations-idorg`

Delete an Organization from an Enterprise.

## `coily ops trello-api enterprises enterprises-id-members-id-member-deactivated`

Deactivate a Member of an Enterprise.

Flags: --board_fields, --fields, --organization_fields, --value

## `coily ops trello-api enterprises enterprises-id-organizations-idmember`

Remove a Member as admin from Enterprise.

## `coily ops trello-api enterprises get-enterprises-id`
...
## `coily ops trello-api enterprises get-enterprises-id-admins`

Get Enterprise admin Members

Flags: --fields

## `coily ops trello-api enterprises get-enterprises-id-auditlog`

Get auditlog data for an Enterprise

## `coily ops trello-api enterprises get-enterprises-id-claimable-organizations`

Get ClaimableOrganizations of an Enterprise

Flags: --activeSince, --cursor, --inactiveSince, --limit, --name

## `coily ops trello-api enterprises get-enterprises-id-members`

Get Members of Enterprise

Flags: --board_fields, --count, --fields, --filter, --organization_fields, --sort, --sortBy, --sortOrder, --startIndex

## `coily ops trello-api enterprises get-enterprises-id-members-idmember`

Get a Member of Enterprise

Flags: --board_fields, --fields, --organization_fields

## `coily ops trello-api enterprises get-enterprises-id-organizations`

Get Organizations of an Enterprise

Flags: --count, --fields, --filter, --startIndex

## `coily ops trello-api enterprises get-enterprises-id-organizations-bulk-id-organizations`

Bulk accept a set of organizations to an Enterprise.

## `coily ops trello-api enterprises get-enterprises-id-pending-organizations`

Get PendingOrganizations of an Enterprise

Flags: --activeSince, --inactiveSince

## `coily ops trello-api enterprises get-enterprises-id-signupurl`

Get signupUrl for Enterprise

Flags: --authenticate, --confirmationAccepted, --returnUrl, --tosAccepted

## `coily ops trello-api enterprises get-enterprises-id-transferrable-bulk-id-organizations`

Get a bulk list of organizations that can be transferred to an enterprise.

## `coily ops trello-api enterprises get-enterprises-id-transferrable-organization-id-organization`

Get whether an organization can be transferred to an enterprise.

## `coily ops trello-api enterprises get-users-id`

Get Users of an Enterprise

Flags: --activeSince, --admin, --collaborator, --cursor, --deactivated, --inactiveSince, --licensed, --managed, --search

## `coily ops trello-api enterprises post-enterprises-id-tokens`

Create an auth Token for an Enterprise.

Flags: --expiration

## `coily ops trello-api enterprises put-enterprises-id-admins-idmember`

Update Member to be admin of Enterprise

## `coily ops trello-api enterprises put-enterprises-id-enterprise-join-request-bulk`

Decline enterpriseJoinRequests from one organization or a bulk list of organizations.

Flags: --idOrganizations

## `coily ops trello-api enterprises put-enterprises-id-members-idmember-licensed`

Update a Member's licensed status

Flags: --value

## `coily ops trello-api enterprises put-enterprises-id-organizations`

Transfer an Organization to an Enterprise.

Flags: --idOrganization

## `coily ops trello-api labels delete-labels-id`

Delete a Label

## `coily ops trello-api labels get-labels-id`

Get a Label

Flags: --fields

## `coily ops trello-api labels post-labels`

Create a Label

Flags: --color, --idBoard, --name

## `coily ops trello-api labels put-labels-id`

Update a Label

Flags: --color, --name

## `coily ops trello-api labels put-labels-id-field`

Update a field on a label

Flags: --value

## `coily ops trello-api lists get-lists-id`

Get a List

Flags: --fields

## `coily ops trello-api lists get-lists-id-actions`

Get Actions for a List

Flags: --filter

## `coily ops trello-api lists get-lists-id-board`

Get the Board a List is on

Flags: --fields

## `coily ops trello-api lists get-lists-id-cards`

Get Cards in a List

## `coily ops trello-api lists post-lists`

Create a new List

Flags: --idBoard, --idListSource, --name, --pos

## `coily ops trello-api lists post-lists-id-archiveallcards`

Archive all Cards in List

## `coily ops trello-api lists post-lists-id-moveallcards`

Move all Cards in List

Flags: --idBoard, --idList

## `coily ops trello-api lists put-id-idboard`

Move List to Board

Flags: --value

## `coily ops trello-api lists put-lists-id`

Update a List

Flags: --closed, --idBoard, --name, --pos, --subscribed

## `coily ops trello-api lists put-lists-id-closed`

Archive or unarchive a list

Flags: --value

## `coily ops trello-api lists put-lists-id-field`

Update a field on a List

Flags: --value

## `coily ops trello-api members delete-members-id-boardbackgrounds-idbackground`

Delete a Member's custom Board background

## `coily ops trello-api members delete-members-id-boardstars-idstar`

Delete Star for Board

## `coily ops trello-api members delete-members-id-customboardbackgrounds-idbackground`

Delete custom Board Background of Member

## `coily ops trello-api members delete-members-id-customstickers-idsticker`

Delete a Member's custom Sticker

## `coily ops trello-api members delete-members-id-savedsearches-idsearch`

Delete a saved search

## `coily ops trello-api members get-members-id`
...
## `coily ops trello-api members get-members-id-actions`

Get a Member's Actions

Flags: --filter

## `coily ops trello-api members get-members-id-boardbackgrounds`

Get Member's custom Board backgrounds

Flags: --filter

## `coily ops trello-api members get-members-id-boardbackgrounds-idbackground`

Get a boardBackground of a Member

Flags: --fields

## `coily ops trello-api members get-members-id-boards`

Get Boards that Member belongs to

Flags: --fields, --filter, --lists, --organization, --organization_fields

## `coily ops trello-api members get-members-id-boardsinvited`

Get Boards the Member has been invited to

Flags: --fields

## `coily ops trello-api members get-members-id-boardstars`

Get a Member's boardStars

## `coily ops trello-api members get-members-id-boardstars-idstar`

Get a boardStar of Member

## `coily ops trello-api members get-members-id-cards`

Get Cards the Member is on

Flags: --filter

## `coily ops trello-api members get-members-id-customboardbackgrounds`

Get a Member's custom Board Backgrounds

## `coily ops trello-api members get-members-id-customboardbackgrounds-idbackground`

Get custom Board Background of Member

## `coily ops trello-api members get-members-id-customemoji`

Get a Member's customEmojis

## `coily ops trello-api members get-members-id-customstickers`

Get Member's custom Stickers

## `coily ops trello-api members get-members-id-customstickers-idsticker`

Get a Member's custom Sticker

Flags: --fields

## `coily ops trello-api members get-members-id-field`

Get a field on a Member

## `coily ops trello-api members get-members-id-notification-channel-settings`

Get a Member's notification channel settings

## `coily ops trello-api members get-members-id-notification-channel-settings-channel`

Get blocked notification keys of Member on this channel

## `coily ops trello-api members get-members-id-notifications`
...
## `coily ops trello-api members get-members-id-organizations`

Get Member's Organizations

Flags: --fields, --filter, --paid_account

## `coily ops trello-api members get-members-id-organizationsinvited`

Get Organizations a Member has been invited to

Flags: --fields

## `coily ops trello-api members get-members-id-savedsearches`

Get Member's saved searched

## `coily ops trello-api members get-members-id-savedsearches-idsearch`

Get a saved search

## `coily ops trello-api members get-members-id-tokens`

Get Member's Tokens

Flags: --webhooks

## `coily ops trello-api members membersidavatar`

Create Avatar for Member

Flags: --file

## `coily ops trello-api members membersidcustomboardbackgrounds-1`

Create a new custom Board Background

Flags: --file

## `coily ops trello-api members membersidcustomemojiidemoji`

Get a Member's custom Emoji

Flags: --fields

## `coily ops trello-api members post-members-id-boardbackgrounds-1`

Upload new boardBackground for Member

Flags: --file

## `coily ops trello-api members post-members-id-boardstars`

Create Star for Board

Flags: --idBoard, --pos

## `coily ops trello-api members post-members-id-customemoji`

Create custom Emoji for Member

Flags: --file, --name

## `coily ops trello-api members post-members-id-customstickers`

Create custom Sticker for Member

Flags: --file

## `coily ops trello-api members post-members-id-onetimemessagesdismissed`

Dismiss a message for Member

Flags: --value

## `coily ops trello-api members post-members-id-savedsearches`

Create saved Search for Member

Flags: --name, --pos, --query

## `coily ops trello-api members put-members-id`

Update a Member

Flags: --avatarSource, --bio, --fullName, --initials, --prefs/colorBlind, --prefs/locale, --prefs/minutesBetweenSummaries, --username

## `coily ops trello-api members put-members-id-boardbackgrounds-idbackground`

Update a Member's custom Board background

Flags: --brightness, --tile

## `coily ops trello-api members put-members-id-boardstars-idstar`

Update the position of a boardStar of Member

Flags: --pos

## `coily ops trello-api members put-members-id-customboardbackgrounds-idbackground`

Update custom Board Background of Member

Flags: --brightness, --tile

## `coily ops trello-api members put-members-id-notification-channel-settings-channel-blocked-keys`

Update blocked notification keys of Member on a channel

Flags: --body

## `coily ops trello-api members put-members-id-notification-channel-settings-channel-blocked-keys-put`

Update blocked notification keys of Member on a channel

Flags: --body

## `coily ops trello-api members put-members-id-notification-channel-settings-channel-blocked-keys-put3`

Update blocked notification keys of Member on a channel

## `coily ops trello-api members put-members-id-savedsearches-idsearch`

Update a saved search

Flags: --name, --pos, --query

## `coily ops trello-api notifications get-notifications-id`
...
## `coily ops trello-api notifications get-notifications-id-board`

Get the Board a Notification is on

Flags: --fields

## `coily ops trello-api notifications get-notifications-id-card`

Get the Card a Notification is on

Flags: --fields

## `coily ops trello-api notifications get-notifications-id-field`

Get a field of a Notification

## `coily ops trello-api notifications get-notifications-id-list`

Get the List a Notification is on

Flags: --fields

## `coily ops trello-api notifications get-notifications-id-membercreator`

Get the Member who created the Notification

Flags: --fields

## `coily ops trello-api notifications get-notifications-id-organization`

Get a Notification's associated Organization

Flags: --fields

## `coily ops trello-api notifications notificationsidmember`

Get the Member a Notification is about (not the creator)

Flags: --fields

## `coily ops trello-api notifications post-notifications-all-read`

Mark all Notifications as read

Flags: --ids, --read

## `coily ops trello-api notifications put-notifications-id`

Update a Notification's read status

Flags: --unread

## `coily ops trello-api notifications put-notifications-id-unread`

Update Notification's read status

Flags: --value

## `coily ops trello-api organizations delete-organizations-id`

Delete an Organization

## `coily ops trello-api organizations delete-organizations-id-logo`

Delete Logo for Organization

## `coily ops trello-api organizations delete-organizations-id-members`

Remove a Member from an Organization

## `coily ops trello-api organizations delete-organizations-id-prefs-associateddomain`

Remove the associated Google Apps domain from a Workspace

## `coily ops trello-api organizations delete-organizations-id-prefs-orginviterestrict`

Delete the email domain restriction on who can be invited to the Workspace

## `coily ops trello-api organizations delete-organizations-id-tags-idtag`

Delete an Organization's Tag

## `coily ops trello-api organizations get-organizations-id`

Get an Organization

## `coily ops trello-api organizations get-organizations-id-actions`

Get Actions for Organization

## `coily ops trello-api organizations get-organizations-id-boards`

Get Boards in an Organization

Flags: --fields, --filter

## `coily ops trello-api organizations get-organizations-id-exports`

Retrieve Organization's Exports

## `coily ops trello-api organizations get-organizations-id-field`

Get field on Organization

## `coily ops trello-api organizations get-organizations-id-members`

Get the Members of an Organization

## `coily ops trello-api organizations get-organizations-id-memberships`

Get Memberships of an Organization

Flags: --filter, --member

## `coily ops trello-api organizations get-organizations-id-memberships-idmembership`

Get a Membership of an Organization

Flags: --member

## `coily ops trello-api organizations get-organizations-id-newbillableguests-idboard`

Get Organizations new billable guests

## `coily ops trello-api organizations get-organizations-id-plugindata`

Get the pluginData Scoped to Organization

## `coily ops trello-api organizations get-organizations-id-tags`

Get Tags of an Organization

## `coily ops trello-api organizations organizations-id-members-idmember-all`

Remove a Member from an Organization and all Organization Boards

## `coily ops trello-api organizations post-organizations`

Create a new Organization

Flags: --desc, --displayName, --name, --website

## `coily ops trello-api organizations post-organizations-id-exports`

Create Export for Organizations

Flags: --attachments

## `coily ops trello-api organizations post-organizations-id-logo`

Update logo for an Organization

Flags: --file

## `coily ops trello-api organizations post-organizations-id-tags`

Create a Tag in Organization

## `coily ops trello-api organizations put-organizations-id`
...
## `coily ops trello-api organizations put-organizations-id-members`

Update an Organization's Members

Flags: --email, --fullName, --type

## `coily ops trello-api organizations put-organizations-id-members-idmember`

Update a Member of an Organization

Flags: --type

## `coily ops trello-api organizations put-organizations-id-members-idmember-deactivated`

Deactivate or reactivate a member of an Organization

Flags: --value

## `coily ops trello-api plugins get-plugins-id`

Get a Plugin

## `coily ops trello-api plugins get-plugins-id-compliance-memberprivacy`

Get Plugin's Member privacy compliance

## `coily ops trello-api plugins post-plugins-idplugin-listing`

Create a Listing for Plugin

Flags: --body

## `coily ops trello-api plugins put-plugins-id`

Update a Plugin

## `coily ops trello-api plugins put-plugins-idplugin-listings-idlisting`

Updating Plugin's Listing

Flags: --body

## `coily ops trello-api search get-search`
...
## `coily ops trello-api search get-search-members`

Search for Members

Flags: --idBoard, --idOrganization, --limit, --onlyOrgMembers, --query

## `coily ops trello-api tokens delete-token`

Delete a Token

## `coily ops trello-api tokens delete-tokens-token-webhooks-idwebhook`

Delete a Webhook created by Token

## `coily ops trello-api tokens get-tokens-token`

Get a Token

Flags: --fields, --webhooks

## `coily ops trello-api tokens get-tokens-token-member`

Get Token's Member

Flags: --fields

## `coily ops trello-api tokens get-tokens-token-webhooks`

Get Webhooks for Token

## `coily ops trello-api tokens get-tokens-token-webhooks-idwebhook`

Get a Webhook belonging to a Token

## `coily ops trello-api tokens post-tokens-token-webhooks`

Create Webhooks for Token

Flags: --callbackURL, --description, --idModel

## `coily ops trello-api tokens tokenstokenwebhooks-1`

Update a Webhook created by Token

Flags: --callbackURL, --description, --idModel

## `coily ops trello-api webhooks delete-webhooks-id`

Delete a Webhook

## `coily ops trello-api webhooks get-webhooks-id`

Get a Webhook

## `coily ops trello-api webhooks post-webhooks`

Create a Webhook

Flags: --active, --callbackURL, --description, --idModel

## `coily ops trello-api webhooks put-webhooks-id`

Update a Webhook

Flags: --active, --callbackURL, --description, --idModel

## `coily ops trello-api webhooks webhooksidfield`
